...
<link href="/resources/css/cs/counselor_event.css?i=<%=i_join%>" rel="stylesheet">
...
<body>
	...
	<div id="main_wrap">
				...
				<a>
					<div class="event_div">
						<img src="/resources/img/shoppingmall/cs/counselor/event.png"
							class="event_img background_f4f4f4" />
						<div class="cs_text background_f4f4f4 bold">이벤트</div>
						<img src="/resources/img/shoppingmall/cs/counselor/1406.png"
		...
		<div class="table_title">공지사항</div>
					...
					<c:when test="${fn:length(list)>0 }">
						<c:forEach var="row" items="${list}" varStatus="g">
							...
							<tr>
								...
								<td data-boardidxpk="${row.board_idx_pk }"><img
									src="/resources/img/shoppingmall/cs/counselor_notice/1.png"
									class="notice_move" /></td>
	...
	<!-- 회원가입 자바스크립트 기능 -->
	<script src="/resources/js/cs/counselor_event.js?i=<%=i_join%>"></script>
	<!-- 회원가입 자바스크립트 기능 -->
