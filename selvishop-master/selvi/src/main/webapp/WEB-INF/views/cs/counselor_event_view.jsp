...
<link href="/resources/css/cs/counselor_event_view.css?i=<%=i_join%>" rel="stylesheet">
...
<body>
	...
	<!-- 회원가입 자바스크립트 기능 -->
	<script src="/resources/js/cs/counselor_event_view.js?i=<%=i_join%>"></script>
	<!-- 회원가입 자바스크립트 기능 -->
