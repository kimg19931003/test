...
<script
	src="${pageContext.request.contextPath}/resources/js/member/find_id.js"></script>
</head>
<body>
	<div id="wrap">
		<!-- 아이디 찾기 / 비밀번호 찾기 헤더 -->
			...
			<div class="findArea">
				...
				<div class="findWrap">
					...
					<div class="tabBtn tabTpl">
						<p>
							<button type="button" class="on" rel="find_tab_id">
								<span>아이디 찾기</span>
							</button>
						</p>
						<p>
							<button type="button" class="" rel="find_tab_pass">
								<span>비밀번호 찾기</span>
							</button>
						</p>
					</div>
