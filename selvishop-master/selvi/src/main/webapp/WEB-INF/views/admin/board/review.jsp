...
<link href="/resources/css/admin/board/board_review.css?i=<%=i_board_all %>" rel="stylesheet" type="text/css">
...
<script src="/resources/js/admin/board/review.js?i=<%=i_board_all %>" ></script>
