...
<link
	href="/resources/css/admin/board/board.css?i=<%=i_write %>"
	rel="stylesheet" type="text/css">
<link
	href="/resources/css/admin/board/board_write.css?i=<%=i_write %>"
	rel="stylesheet" type="text/css">
...
<body>
					...
					<div class="scrollbar-inner scroll-content"
						...
						<div class="left-content">
							...
							<div class="setting-row">
								...
								<div class="content">
									<input type="text" id="postWriter" value="이한결" >
								</div>
							</div>
							<div class="setting-row">
								<div class="title">
								...
								<div class="content">
									<input type="text" id="postWriterEmail" value="lsh88@otomediagroup.com"
	...
	<script type="text/javascript" src="/resources/js/admin/board/write.js?i=<%=i_write%>"></script>
