...
<link href="/resources/css/admin/board/board_event.css?i=<%=i_board_all %>" rel="stylesheet" type="text/css">
...
<script src="/resources/js/admin/board/event.js?i=<%=i_board_all %>" ></script>
