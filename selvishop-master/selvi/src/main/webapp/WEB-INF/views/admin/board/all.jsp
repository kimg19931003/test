...
<link href="/resources/css/admin/board/board_all.css?i=<%=i_board_all %>" rel="stylesheet" type="text/css">
...
<script src="/resources/js/admin/board/all.js?i=<%=i_board_all %>" ></script>
