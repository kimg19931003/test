...
<link href="/resources/css/admin/board/board_notice.css?i=<%=i_board_all %>" rel="stylesheet" type="text/css">
...
<script src="/resources/js/admin/board/notice.js?i=<%=i_board_all %>" ></script>
