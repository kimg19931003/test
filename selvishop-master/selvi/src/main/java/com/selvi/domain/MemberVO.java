...
public class MemberVO {
	 ...
	 * 		`call1` varchar(50) DEFAULT NULL,
	 * 		`pass_cert` varchar(50) DEFAULT NULL,
	 * 		`bank_agree` varchar(50) NOT NULL DEFAULT 'n',
	 * 		`email` varchar(200) DEFAULT NULL,
	 * 		`email_ok` varchar(200) NOT NULL DEFAULT 'n',
	 * 		`email_pass` varchar(200) DEFAULT NULL,
	 * 		`person_num` varchar(100) DEFAULT NULL,
	 * 		`pass_change_state` varchar(30) NOT NULL DEFAULT 'n',
	 * 		`user_name` varchar(100) DEFAULT NULL,
	 * 		`bank_name` varchar(100) DEFAULT NULL,
	 * 		`bank_num` varchar(100) DEFAULT NULL,
	 * 		`bank_insert_clear` varchar(100) DEFAULT NULL,
	 * 		`bank_refund_wait` varchar(100) DEFAULT NULL,
	 * 		`bank_refund_total_price` varchar(100) DEFAULT NULL,
	 * 		`ftime` varchar(100) DEFAULT NULL,
	 * 		`realtime` varchar(100) DEFAULT NULL,
	 * 		`tax_agree` varchar(30) NOT NULL DEFAULT 'n',
	 * 		`bank_policy_agree` varchar(30) NOT NULL DEFAULT 'n',
	 * 		`product_no` varchar(100) DEFAULT NULL,
	 * 		`deleted` varchar(30) NOT NULL DEFAULT 'n',
	 * 		PRIMARY KEY (`eid`)
