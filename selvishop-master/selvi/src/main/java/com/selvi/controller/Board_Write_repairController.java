...
@Controller
public class Board_Write_repairController {
	// 로깅을 위한 변수
	...
	@RequestMapping(value = "/board_image_add", method = RequestMethod.POST)
	@ResponseBody
	public void product_image_add(HttpServletRequest req, HttpSession sessions, HttpServletResponse response)
		...
		String path = defaultPath + "resources/img/admin/board/";
		...
		os.flush();
		os.close();
		sFileInfo += "&bNewLine=true&sFileName=" + name + "&sFileURL=" + "/resources/img/admin/board/" + realname;
	...
	public void board_add(HttpServletRequest req, HttpSession sessions) throws Exception {
		...
		String path = "C:/Users/DD Studio/git/selvi/selvi/src/main/webapp/resources/img/admin/board/";
